...
<section class="py-6 bg-[#0f0f0f] border-b border-[#333] hidden md:block">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div>
                ...
                <select wire:model.live="brand_id"
                        class="w-full bg-[#2D2D2D] border border-[#444] px-3 py-2 rounded-lg">
        ...
        <div class="mt-4">
            <button wire:click="resetFilters"
                    class="bg-[#2D2D2D] text-white px-4 py-2 rounded-lg">
...
<section class="bg-[#0f0f0f] border-b border-[#333] md:hidden py-4">
    <div class="container mx-auto px-4 flex justify-between items-center">
        <h3 class="text-lg font-semibold text-white">Filter</h3>

        <button wire:click="toggleFilters"
                class="px-4 py-2 bg-[#2D2D2D] text-white rounded-lg flex items-center gap-2">
            <i class="fas {{ $filtersOpen ? 'fa-chevron-up' : 'fa-filter' }}"></i>
            {{ $filtersOpen ? 'Schließen' : 'Filtern' }}
        </button>
    </div>
</section>
...
<!-- 🔥 MOBILE FILTER PANEL -->
<div class="@if(!$filtersOpen) hidden @endif md:hidden bg-[#0f0f0f] border-b border-[#333] py-6">
    <div class="container mx-auto px-4">
